...
const TopItCompanyWorldWide = () => {
    const [companyWorld, setCompanyWorld] = useState([]);
    ...
    useEffect(() => {
        ...
        fetch('/data.json')
            ...
            .then((data) => {
                ...
                const companyData = data.filter((job) => job.title === 'companyWorld');
                setCompanyWorld(companyData);
            })
            .catch((error) => {
...
export default TopItCompanyWorldWide;